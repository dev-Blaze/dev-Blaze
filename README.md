...
<img src="assets/h-what-i-do.62af1cce.svg" height="34" alt="What I do">
...
- **Make failure survivable** — restic backups to a NAS and S3, config-as-code with diff-only commits, written restore runbooks, and resumable state on anything that changes the world.
...
<img src="assets/h-technologies.7e78655e.svg" height="34" alt="Technologies I know well">

<img src="assets/technologies.a0b7e934.svg" width="880" alt="Table of technologies by area: networking, identity and security, backups and storage, containers, platforms, observability and alerting, automation and CI, AI tooling, data, languages, Microsoft 365 and Google Workspace, commerce and ERP">
